...
static void help()
{
    printf("program         trainXFile  trainYFile  ValidXFile ValidYFile   DTParamFile   modelFile  \n");
    printf("DTR_train_val   train_x.mat train_y.mat valid_x.mat valid_y.mat dtr_param.txt model.txt \n");
...
int main(int argc, const char * argv[])
{
    ...
    vector<Eigen::VectorXf> valid_labels;
    readRegressionDataset(valid_feature_file, valid_label_file, valid_features, valid_labels);
    ...
    builder.buildModel(model, train_features, train_labels,
                       valid_features,  valid_labels, model_file);
